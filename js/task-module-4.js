...
// const uniqueGenres = allGenres.filter((genres, i, book) => book.indexOf(genres) === i);
...
// const totalPlayTime = playtimes.reduce((previousTotalTime, time) => {
//   return previousTotalTime + time;
// });
...
//   const namesSort = [...users].sort((firstName, secondName) =>
...
//   return [...users]
//     .sort(
//       (firstNamesFriend, secondNamesFriend) =>
//         firstNamesFriend.friends.length - secondNamesFriend.friends.length,
//     )
//     .map(user => user.name);
// };
// console.log(
...
//     .filter((friend, i, user) => user.indexOf(friend) === i)
//     .sort((firstNameFriend, secondNameFriend) => firstNameFriend.localeCompare(secondNameFriend));
// };
// console.log(
//   getNamesSortedByFriendCount([
//     {
